...
public class ItemPerfectUpgrade extends Item {
	public ItemPerfectUpgrade() {
		setUnlocalizedName("perfectupgrade");
		setRegistryName("perfectupgrade");
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if(player.getHeldItem(hand).getItem() == this) {
			...
			if(te instanceof TileEntityUpgradeable) {
				if(((TileEntityUpgradeable)te).upgrade(EnumUpgrades.Perfect)) {
